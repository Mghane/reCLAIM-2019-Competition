...
dff <- df[which(df$TimeDiff_RigRelease_Spud<40 & df$TimeDiff_RigRelease_Spud>0),]
...
qplot(Comp_Events/(TimeDiff_RigRelease_Spud), data = dff, bins=100, fill=well_status,ylim = c(0,1000) ,xlim = c(0,10), facets =well_status~.)
qplot(well_status,DaysDrilling , data =dff, geom ="boxplot")
qplot(TimeDiff_RigRelease_Spud, data = dff, bins=100, fill=well_status, facets =well_status~.)
##
